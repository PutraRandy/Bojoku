...
cl = LINETCR.LINE()
cl.login(token="Epq7UWC8cDraapDMvq95.nqZhqiZgZilGvU4eyth5jq.jcQyM3CF1ZhX6XiZpoxouKgNg+eZRClFhBe0O9vZG/Y=")
cl.loginResult()
...
#========================== B O T ``C O M M A N D =============================#
#==============================================================================#
            elif msg.text.lower() == 'Selfbot on':
                if wait["Selfbot"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"selfbot set to on")
                    else:
                        cl.sendText(msg.to,"selfbot already on")
                else:
                    wait["Selfbot"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"selfbot set to on")
                ...
                if wait["Selfbot"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"selfbot set to off")
                    else:
                        cl.sendText(msg.to,"selfbot alreadyoff")
                else:
                    wait["Selfbot"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"selfbot set to off")
                    else:
                        cl.sendText(msg.to,"selfbot already off")
#=======================================================================#
                ...
                if wait["Selfbot"] == True: md+="Selfbot:on \n"
                else: md +="Selfbot:off \n"
...
#==============================================#
        ...
        if op.type == 0:
            if wait["Selfbot"] == True:
                if op.param2 in Bost:
                    return
                cl.sendText(op.param1,"Selfbot aktif")
                print "SELFBOT"
        if op.type == 19:
            if op.param2 not in Bots:
                if op.param2 in Bots:
